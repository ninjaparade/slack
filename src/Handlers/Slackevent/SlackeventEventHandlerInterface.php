...
interface SlackeventEventHandlerInterface extends BaseEventHandlerInterface {

	/**
	 * When a slackevent is being created.
	 *
	 * @param  array  $data
	 * @return mixed
	 */
	...
	/**
	 * When a slackevent is being updated.
	 *
	 * @param  \Ninjaparade\Slack\Models\Slackevent  $slackevent
	 * @param  array  $data
	 * @return mixed
