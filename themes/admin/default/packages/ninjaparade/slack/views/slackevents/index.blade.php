...
@section('title')
@parent
{{ trans('ninjaparade/slack::slackevents/common.title') }}
@stop
...
{{ Asset::queue('index', 'ninjaparade/slack::slackevents/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('ninjaparade/slack::slackevents/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.ninjaparade.slack.slackevents.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="slackevent" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="slackevent" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="slackevent" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="slackevent" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="slackevent"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.ninjaparade.slack.slackevents.grid') }}" data-grid="slackevent">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('ninjaparade/slack::slackevents/model.general.id') }}}</th>
					<th class="sortable" data-sort="name">{{{ trans('ninjaparade/slack::slackevents/model.general.name') }}}</th>
					<th class="sortable" data-sort="channel">{{{ trans('ninjaparade/slack::slackevents/model.general.channel') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('ninjaparade/slack::slackevents/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="slackevent"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('ninjaparade/slack::slackevents/grid/index/results')
	@include('ninjaparade/slack::slackevents/grid/index/pagination')
	@include('ninjaparade/slack::slackevents/grid/index/filters')
	@include('ninjaparade/slack::slackevents/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('ninjaparade/slack::slackevents/help')
@endif
