...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'slackevent');

		$('.daterangepicker_end_input').attr('data-grid', 'slackevent');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('slackevent', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
