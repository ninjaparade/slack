...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'slackchannel');

		$('.daterangepicker_end_input').attr('data-grid', 'slackchannel');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('slackchannel', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
